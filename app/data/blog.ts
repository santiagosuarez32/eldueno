...
export const mockBlogPosts: BlogPost[] = [
  {
    slug: 'por-que-trabajar-con-empresa-bienes-raices',
    category: 'Guía Práctica',
    date: '12 de Junio, 2026',
    readTime: '5 min',
    author: 'Empresa Inmobiliaria Team',
    title: '¿Por qué trabajar con una empresa de bienes raíces?',
    excerpt: 'El mercado inmobiliario puede ser complejo y competitivo, por lo que contar con el apoyo de una empresa de bienes raíces se convierte en una decisión estratégica para cualquier persona que desee comprar, vender o invertir en una propiedad.',
    image: 'https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    content: `¿Por qué trabajar con una empresa de bienes raíces?
...
Trabajar con una empresa de bienes raíces no solo facilita el proceso, sino que también brinda seguridad, confianza y mejores resultados. Es una inversión inteligente que garantiza acompañamiento profesional en una de las decisiones más importantes: tu patrimonio.`
  ...
  {
    slug: 'primeros-pasos-para-comprar-una-propiedad',
    category: 'Guía Práctica',
    date: '8 de Junio, 2026',
    readTime: '7 min',
    author: 'Primeros Pasos',
    title: 'Primeros pasos para comprar una propiedad',
    excerpt: 'Comprar una propiedad es una de las decisiones financieras más importantes en la vida de una persona. Para hacerlo de manera segura y exitosa, es fundamental seguir un proceso ordenado que permita tomar decisiones informadas.',
    image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
    content: `Primeros pasos para comprar una propiedad
...
Es el contrato preliminar donde se pactan el precio, la forma de pago, la fecha de escrituración y la entrega de la posesión. Generalmente se realiza un pago de reserva (seña) y es aconsejable que sea redactado y certificado por un escribano público.`
  },
  {
    ...
    excerpt: 'Analizamos los cantones y distritos que están experimentando el mayor auge inmobiliario, ideales para invertir o mudarte.',
