        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-12 border-b border-white/20">
            <div className="space-y-6 max-w-3xl">
              ...
              <div className="flex flex-wrap gap-x-10 gap-y-6 pt-1">
                <div>
                  <span className="flex items-center gap-1.5 text-xs text-slate-300 font-bold mb-2">
                ...
                <div>
                  <span className="flex items-center gap-1.5 text-xs text-slate-300 font-bold mb-2">
                    <FaWhatsapp className="h-4 w-4 text-[#FFFF33]" /> WhatsApp
                  </span>
                  <a href="https://wa.me/50686208287" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#FFFF33] transition-colors font-medium text-sm sm:text-base block">+506 8620-8287</a>
                </div>
                <div>
                  <span className="flex items-center gap-1.5 text-xs text-slate-300 font-bold mb-2">
              ...
              <div className="flex items-center space-x-3 pt-1">
                <a href="https://www.facebook.com/elduenovende/?locale=ga_IE" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-slate-800 flex items-center justify-center text-[#FFFF33] hover:text-white hover:border-[#FFFF33] hover:bg-slate-900 transition-all duration-200">
                  <FaFacebookF className="h-4.5 w-4.5" />
                </a>
                <a href="https://www.instagram.com/elduenovendecr/?hl=es-la" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-slate-800 flex items-center justify-center text-[#FFFF33] hover:text-white hover:border-[#FFFF33] hover:bg-slate-900 transition-all duration-200">
                  <FaInstagram className="h-4.5 w-4.5" />
                </a>
                <a href="https://www.tiktok.com/@el.duenovende.cr" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-slate-800 flex items-center justify-center text-[#FFFF33] hover:text-white hover:border-[#FFFF33] hover:bg-slate-900 transition-all duration-200">
                  <FaTiktok className="h-4.5 w-4.5" />
                </a>
                <a href="https://www.youtube.com/@duenovendecr3368" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-slate-800 flex items-center justify-center text-[#FFFF33] hover:text-white hover:border-[#FFFF33] hover:bg-slate-900 transition-all duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link href="/" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Inicio</Link>
                </li>
                <li>
                  <Link href="/nosotros" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Nosotros</Link>
                </li>
                <li>
                  <Link href="/propiedades" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="text-slate-300 hover:text-[#FFFF33] transition-colors">Propiedades</Link>
                </li>
                <li>
                  <Link href="/contacto" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Contacto</Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link href="/compra-y-venta" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Compra y Venta de Propiedades</Link>
                </li>
                <li>
                  <Link href="/prestamos" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Préstamos hipotecarios</Link>
                </li>
                <li>
                  <Link href="/arquitectura" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Servicios de arquitectura</Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <a href="https://maps.app.goo.gl/bXBuQFYZQaJPcEzr5?g_st=iwb" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-[#FFFF33] transition-colors">Heredia, Asunción de Belén, diagonal a la plaza de deportes.</a>
                </li>
              </ul>
            </div>
          </div>
