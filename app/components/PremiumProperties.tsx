          ...
          {loading ? (
            <>
              {Array.from({ length: 4 }).map((_, idx) => (
                <div
                  key={idx}
                  className={`relative flex-shrink-0 lg:flex-shrink snap-start h-[450px] lg:h-[460px] rounded-[32px] overflow-hidden ${
                    idx === 0
                      ? 'w-[320px] sm:w-[480px] lg:w-auto lg:flex-[1.6] bg-slate-100 p-3.5'
                      : 'w-[280px] lg:w-auto lg:flex-[1] bg-slate-200 p-0'
                  }`}
                >
