      ...
      <main ref={container} className="flex-grow bg-slate-950 text-slate-900">
        ...
        <section className="py-8 sm:py-10 bg-white relative">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-8 lg:space-y-10 mt-6 max-w-6xl mx-auto">

              {/* Section 1 */}
              <div className="service-section grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
                <div
                  className="service-left order-2 lg:order-1 space-y-4"
                >
                  <div className="w-12 h-12 bg-slate-950 text-[#FFFF33] rounded-full flex items-center justify-center font-bold text-xl shadow-md">
                    1
                  </div>
                  ...
                  <ul className="space-y-3 pt-1">
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center shadow-md mt-0.5">
              ...
              <div className="service-section grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
                ...
                <div
                  className="service-right order-2 lg:order-2 space-y-4"
                >
                  <div className="w-12 h-12 bg-slate-950 text-[#FFFF33] rounded-full flex items-center justify-center font-bold text-xl shadow-md">
                    2
                  </div>
                  ...
                  <ul className="space-y-3 pt-1">
                    <li className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center font-bold text-sm shadow-md flex-shrink-0 mt-0.5">1</div>
                    ...
                    <li className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center font-bold text-sm shadow-md flex-shrink-0 mt-0.5">2</div>
                      <span className="text-slate-600 text-xl">Coordinación de visita del perito. Avalúo sin costo.</span>
                    </li>
                    <li className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center font-bold text-sm shadow-md flex-shrink-0 mt-0.5">3</div>
                      <span className="text-slate-600 text-xl">Contrato de exclusividad por un periodo de 6 meses.</span>
                    </li>
                    <li className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center font-bold text-sm shadow-md flex-shrink-0 mt-0.5">4</div>
                      <span className="text-slate-600 text-xl">Visita de nuestro equipo de ventas para toma de fotografías.</span>
                    </li>
                    <li className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center font-bold text-sm shadow-md flex-shrink-0 mt-0.5">5</div>
                    ...
                    <li className="flex gap-4 items-start">
                      <div className="w-8 h-8 rounded-full bg-slate-950 text-[#FFFF33] flex items-center justify-center font-bold text-sm shadow-md flex-shrink-0 mt-0.5">6</div>
        ...
        <section id="formulario-compra-venta" className="w-full bg-slate-950 min-h-[calc(100vh-80px)] flex items-center py-6 lg:py-8 relative overflow-hidden">
          <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
              ...
              <div className="lg:col-span-6 p-2 sm:p-4 lg:p-6 flex flex-col justify-center text-left relative">
                ...
                <div className="max-w-2xl relative z-10">
                  <span className="inline-flex items-center justify-center px-4 py-1.5 bg-[#FFFF33] text-slate-950 text-base font-bold rounded-full mb-4 w-max">
                    Asesoría experta • Respaldo real
                  </span>
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-[1.1] mb-4 tracking-tight">
                    Vende o alquila tu propiedad con el respaldo de expertos.
                  </h3>
                  <p className="text-slate-200 text-base lg:text-lg leading-relaxed mb-5">
              ...
              {/* Right Side (CRM Form Card - Snug Fit, No Empty Margins) */}
              <div className="lg:col-span-6 relative z-20 flex flex-col justify-center items-center lg:items-end w-full">
                <div className="w-full max-w-[580px] bg-slate-900/90 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl relative">
                  ...
                  <div className="flex items-center justify-between bg-slate-900 border-b border-slate-800/80 px-4 py-2 text-xs text-slate-300 font-semibold">
                    ...
                    <span className="flex items-center gap-1.5 text-[11px] text-slate-200 bg-slate-800/90 px-2.5 py-0.5 rounded-full border border-slate-700/60 shadow-sm">
